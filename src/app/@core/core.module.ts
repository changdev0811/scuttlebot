...
import { BillingsTableData } from './data/billings-table';
import { BillingsTableService } from './mock/billings-table-service';
...
const DATA_SERVICES = [
  ...
  { provide: BillingsTableData, useClass: BillingsTableService },
];
